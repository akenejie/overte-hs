...
public:
    ...
    void encode(const QByteArray& decodedBuffer, QByteArray& encodedBuffer) override;
...
private:
    static const int DEFAULT_BITRATE = 128000;
    static const int DEFAULT_COMPLEXITY = 10;
    static const int DEFAULT_APPLICATION = OPUS_APPLICATION_VOIP;
    static const int DEFAULT_SIGNAL = OPUS_AUTO;
